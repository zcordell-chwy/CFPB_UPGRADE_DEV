    ...
    <rn:condition is_spider="false">
        <div id="rn_SearchControls">
            ...
            <form method="post" action="" onsubmit="return false" >
                ...
                <rn:widget path="search/SearchButton2" report_id="#rn:php:getSetting('FAQS_REPORT_ID')#" report_page_url="/app/answers/help/list"/>
            </form>
...
<div id="rn_PageContent" class="rn_AnswerList">
    <div class="answers_subtab">
        ...
        <div class ="tab">
            <a href = "/app/answers/help/listnews">News</a>
        </div>
    </div>
    <div class="rn_Padding">
        ...
        <rn:widget path="reports/Paginator" report_id="#rn:php:getSetting('FAQS_REPORT_ID')#"/>
    </div>
</div>
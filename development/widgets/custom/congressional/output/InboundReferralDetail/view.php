<rn:meta controller_path="custom/congressional/output/InboundReferralDetail"/>
	...
	<rn:widget path="custom/congressional/output/DataDisplayIA" name="incidents.c$referred_to" label="Referred to:" />
        <br>
	<!-- ++++++++++ Company Response ++++++++++ -->
        <h3 class="rn_HeadingBar"><?=getLabel('COMPANY_RESPONSE_HDR');?></h3>

		<rn:widget path="custom/congressional/output/DataDisplayIA" name="incidents.c$comp_provide_a_response" label="Company response:" />
		<rn:widget path="custom/congressional/output/DataDisplayIA" name="incidents.c$past_due_flag" label="Timely response?" negate_value="true" />

<rn:meta controller_path="custom/instAgent/input/TextLogicInput2" 
    js_path="custom/instAgent/input/TextLogicInput2" 
...
<? if($this->data['attrs']['is_copy']):?>
<span class="rn_Hidden" id="review_<?=$this->data['js']['name']?>_copy"></span>  
<? endif;?>
...
case EUF_DT_INT:
?>
  <? // fix for ie7 for nbccestvalue only ?>
  <? if ($this->data['js']['name'] === 'nbccestvalue'):?><span>$</span><?endif;?>
  ...
  <label for="rn_<?=$this->instanceID;?>_<?=$this->data['js']['name'];?>" id="rn_<?=$this->instanceID;?>_Label" class="rn_infield">
    ...
    <? elseif (isset($this->data['attrs']['label_optional']) && strlen($this->data['attrs']['label_optional']) > 0):?>
    	<span><?=$this->data['attrs']['label_optional'];?></span>
    <? endif;?>

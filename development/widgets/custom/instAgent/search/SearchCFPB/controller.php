...
class SearchCFPB extends Widget
{
    function __construct()
    {
        ...
        $this->attrs['search_state'] = new Attribute( "Search State", 'BOOL', "Flag to optionally hide the state filter. Defaults to true, showing the filter if a government portal user.", true );

        ...
        <div id="rn_SearchControls">
            ...
            <form method="post" action="" onsubmit="return false" >
                <div class="rn_SearchInput">
                    <?/*<rn_:widget path="search/AdvancedSearchDialog" report_id="#rn:php:getSetting('FAQS_REPORT_ID')#" show_confirm_button_in_dialog="true"/>*/?>
                ...
                <rn:widget path="search/SearchButton2" report_id="#rn:php:getSetting('FAQS_REPORT_ID')#"/>
            </form>
...
<div id="rn_PageContent" class="rn_AnswerList">
    <div class="rn_Padding">
        ...
        <rn:widget path="reports/ResultInfo2" report_id="#rn:php:getSetting('FAQS_REPORT_ID')#" add_params_to_url="p,c"/>
        ...
        <rn:widget path="reports/Paginator" report_id="#rn:php:getSetting('FAQS_REPORT_ID')#" maximum_page_links="27"/>
    </div>
</div>

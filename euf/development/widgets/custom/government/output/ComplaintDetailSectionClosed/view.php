<rn:meta controller_path="custom/government/output/ComplaintDetailSectionClosed"/>
	  ...
	  <rn:widget path="custom/instAgent/output/DataDisplayIA" name="incidents.c$cc_co_name" label="Company name:"/>
          ...
          <table id="mt_sender_recipient_table">
            <tbody>
              ...
              <tr>
                <td>&nbsp;</td>
                <td><rn:widget path="custom/output/FormReviewFieldDisplay4" label="Submit a complaint against this company?" name="FileComplaintAgainstCreditor" table="DebtCollection" namespace="Complaints"/></td>
              </tr>
            </tbody>
          </table>
        <? } else { ?>
	...
	<rn:widget path="custom/instAgent/output/DataDisplayIA" alt_field="incidents.c$comp_status_archive" label="Company status:" name="incidents.status"
	    suppress_field_unless_value_equals="Referred to agency" />

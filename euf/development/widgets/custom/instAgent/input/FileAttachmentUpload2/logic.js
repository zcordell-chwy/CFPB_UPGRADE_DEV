RightNow.Widget.FileAttachmentUpload2 = function(data, instanceID)
{
    ...
    this._divAttach = document.getElementById("rn_" + this.instanceID);
    ...
    this._inputFieldLabel = document.getElementById("rn_" + this.instanceID + "_FileInputLabel");
    ...
    if(this._parentForm)
    {
        ...
        // this is only neccesary if we were going to add attachments to custom objects other than incidents
        //RightNow.Event.subscribe("evt_setAttachIncident", function(){this.data.attrs.table = 'incidents';}, this);
        //RightNow.Event.subscribe("evt_setAttachInvestigation", function(){this.data.attrs.table = 'CO_Invest$Investigation'}, this);
        RightNow.Event.subscribe("evt_hideAttach", function(){this._divAttach.className="rn_Hidden";}, this);
        RightNow.Event.subscribe("evt_showAttach", function(){this._divAttach.className="rn_FileAttachmentUpload2";}, this);
    }
    else
    {
...
RightNow.Widget.FileAttachmentUpload2.prototype = {
    /**

<rn:meta controller_path="custom/instAgent/input/FileAttachmentUpload2" js_path="custom/instAgent/input/FileAttachmentUpload2" base_css="standard/input/FileAttachmentUpload2" presentation_css="widgetCss/FileAttachmentUpload2.css"  compatibility_set="November '09+"/>

<div id="rn_<?=$this->instanceID;?>" class="rn_FileAttachmentUpload2">
    <label for="rn_<?=$this->instanceID;?>_FileInput" id="rn_<?=$this->instanceID;?>_FileInputLabel"><?=$this->data['attrs']['label_input'];?></label>
    <div class="attach">
        ...
        <button type="button" class="attach" onclick="RightNow.Event.fire('evt_browseClick');">Attach</button>
    </div>

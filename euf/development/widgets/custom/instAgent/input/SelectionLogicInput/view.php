<rn:meta controller_path="custom/instAgent/input/SelectionLogicInput"
    js_path="custom/instAgent/input/SelectionLogicInput"
...
<div id="rn_<?=$this->instanceID;?>" class="rn_SelectionInput" style="clear:both">
    ...
    <label for="rn_<?=$this->instanceID;?>_<?=$this->data['js']['name'];?>" id="rn_<?=$this->instanceID;?>_Label" class="rn_Label" style="<?= $this->data['attrs']['label_style']; ?>">

<rn:meta controller_path="custom/instAgent/output/FileListDisplayIA"  
    ...
    <div  id="rn_<?=$this -> instanceID;?>" class="rn_FileListDisplay">
        ...
        <div class="rn_DataValue<?=$this->data['wrapClass']?>">
                <? for($i=0; $i<count($this->data['value']); $i++):
                     ...
                     // CR 475 - Hide IGT response and close letters from company
                     if (preg_match("/(?:IGT Final Response.pdf|CloseLetter.pdf)\$/i",$this->data['value'][$i][1])) { continue; }

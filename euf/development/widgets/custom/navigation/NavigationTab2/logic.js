...
RightNow.Widget.NavigationTab2.prototype = {
    /**
    ...
    */
    _openDropdown: function()
    {
        if(!this._dropdownOpen)
        {
            ...
            YAHOO.util.Dom.setStyle(this._dropdownElement, "top", (this._tabRegion.bottom - 4) + "px");
            var left = YAHOO.util.Dom.hasClass(this._tabElement, this.data.attrs.css_class) ? 4 : 0;
            YAHOO.util.Dom.setStyle(this._dropdownElement, "left", (this._tabRegion.left - left) + "px");
